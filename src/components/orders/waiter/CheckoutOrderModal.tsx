...
export default function CheckoutOrderModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Opsi Cetak Pesanan" maxWidth="6xl">
      <div className="flex flex-col h-[75vh] bg-gray-50 rounded-b-2xl overflow-hidden -mx-6 -mb-6">
        ...
        <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
          <div className={`${activeTab === "pesanan" ? "flex" : "hidden"} lg:flex w-full lg:w-[50%] flex-col bg-white border-r border-gray-200 flex-1 min-h-0`}>
          ...
          <div className={`${activeTab === "preview" ? "flex-1 min-h-0" : "hidden"} lg:flex lg:flex-none lg:min-h-0 w-full lg:w-[50%] bg-gray-100 p-6 flex-col items-center overflow-y-auto relative`}>
